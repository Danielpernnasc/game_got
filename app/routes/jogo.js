module.exports = function(application){
	...
	application.get('/pergaminhos', function(req, res){
		application.app.controllers.jogo.pergamninhos(application, req, res)
	});
	...
	application.post('/paginanegada', function(req, res){
		application.app.controllers.jogo.paginanegada(application, req, res)
	});
